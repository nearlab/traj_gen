...
void rungeKutta(Eigen::VectorXd (*dydt)(double, Eigen::VectorXd, Eigen::VectorXd, TrajParams), Eigen::VectorXd& y, const double& t0, const double& tf, const double& dt, const TrajParams& p);
